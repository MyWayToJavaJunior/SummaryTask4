...
<%@ include file="/WEB-INF/view/jspf/header.jspf" %>
	...
	<form id="add_faculty" action="controller" method="POST">
		<input type="hidden" name="command" value="addFaculty" /> <input
			type="hidden" name="show" value="false" /> <label for="name">Faculty
			name:</label> <input type="text" name="name" value="" /> <label
			for="total_seats">Total seats:</label> <input type="text"
			name="total_seats" value="" /> <label for="budget_seats">Budget
